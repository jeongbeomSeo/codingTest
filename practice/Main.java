...
public class Main {
    ...
    private static int lower_bound(List<Integer> list, int left, int right, int target) {
        while (left < right) {
    ...
    private static int upper_bound(List<Integer> list, int left, int right, int target) {
        while (left < right) {
            int mid = (left + right) / 2;
